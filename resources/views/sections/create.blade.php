...
<div class="max-w-4xl mx-auto mt-10 bg-white p-6 rounded-xl shadow">
    ...
    <form action="{{ route('sections.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <textarea name="description" placeholder="Description" class="w-full border px-3 py-2 rounded" rows="3"></textarea>
        ...
        <input type="text" name="buttonlink" placeholder="Button Link" class="w-full border px-3 py-2 rounded">
