        ...
        <div class="card-body">
            <form action="{{ route('plans.update', $plan) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    <label>Title</label>
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $plan->title) }}">
                    @error('title')
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="description" class="form-control tinymce">{{ old('description', $plan->description) }}</textarea>
                </div>
                <div class="mt-3">
